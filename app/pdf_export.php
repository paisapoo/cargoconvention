     ...
     <div class="form-group" id="show-attendee" style="padding:0 3em;margin-bottom: 1rem;">
              ...
              <div class="form-group" id="show-attendee" style="padding:0 3em;margin-bottom: 1rem;">
                ...
                <?php if($_SESSION['booking1'][0]['spouse']){?>
                  <div class="col-md-12 form-boder" style="border-bottom:1px solid #d8d8d8;margin-bottom:0.5em; position:relative;width:100%;">
                    <div class="form-group" id="show-spouse" style="padding:0 3em;margin-bottom: 1rem;">
                      ...
                      <?php } ?>
                        ...
                        <div class="col-md-12 form-boder" style="border-bottom:1px solid #d8d8d8;margin-bottom:0.5em;position:relative;width:100%;padding-right:15px;padding-left:15px;">
                          <div class="form-group" style="padding:0 3em;margin-bottom: 1rem;">
