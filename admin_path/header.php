...
<head>
    ...
    <!-- normalize CSS
    ============================================ -->
    <link rel="stylesheet" href="css/admin/data-table/bootstrap-table.css">
    <link rel="stylesheet" href="css/admin/data-table/bootstrap-editable.css">
    <!-- normalize CSS
    ============================================ -->
    <link rel="stylesheet" href="css/admin/normalize.css">
    <!-- charts CSS
    ============================================ -->
    <link rel="stylesheet" href="css/admin/c3.min.css">
    <!-- style CSS
    ============================================ -->
